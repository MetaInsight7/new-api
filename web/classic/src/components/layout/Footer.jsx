...
const FooterBar = () => {
  ...
  const customFooter = useMemo(
    () => (
      <footer className='relative h-auto py-16 px-6 w-full flex flex-col items-center justify-between overflow-hidden'>
        {isDemoSiteMode && (
  ...
  return (
    <div className='w-full'>
      {footer ? (
        <footer className='relative h-auto py-4 px-6 w-full flex items-center justify-center overflow-hidden'>
