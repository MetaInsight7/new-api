        ...
        <div className='space-y-4'>
          ...
          <Card className='!rounded-xl w-full' bodyStyle={{ padding: '12px' }}>
            <div className='flex items-center justify-between mb-3'>
              <Skeleton loading={true} active placeholder={<Skeleton.Title style={{ width: 100, height: 20 }} />} />
              <Skeleton loading={true} active placeholder={<Skeleton.Button style={{ width: 24, height: 24 }} />} />
            </div>
            <div className='space-y-2'>
              <Skeleton loading={true} active placeholder={<Skeleton.Paragraph rows={2} />} />
            </div>
          </Card>
          {/* 套餐列表骨架屏 */}
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5 w-full px-1'>
            {[1, 2, 3].map((i) => (
              ...
              >
                <Skeleton loading={true} active placeholder={<Skeleton.Title style={{ width: '60%', height: 24, marginBottom: 8 }} />} />
                <Skeleton loading={true} active placeholder={<Skeleton.Paragraph rows={1} style={{ marginBottom: 12 }} />} />
                <div className='text-center py-4'>
                  <Skeleton loading={true} active placeholder={<Skeleton.Title style={{ width: '40%', height: 32, margin: '0 auto' }} />} />
                </div>
                <Skeleton loading={true} active placeholder={<Skeleton.Paragraph rows={3} style={{ marginTop: 12 }} />} />
                <Skeleton loading={true} active placeholder={<Skeleton.Button block style={{ marginTop: 16, height: 32 }} />} />
              </Card>
            ))}
          </div>
        </div>
