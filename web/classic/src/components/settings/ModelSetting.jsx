    ...
    <>
      <Spin spinning={loading} size='large'>
        ...
        <Card style={{ marginTop: '10px' }}>
          <SettingGlobalModel options={inputs} refresh={refresh} />
        </Card>
        {/* Channel affinity */}
        <Card style={{ marginTop: '10px' }}>
          <SettingsChannelAffinity options={inputs} refresh={refresh} />
        </Card>
        {/* Gemini */}
        <Card style={{ marginTop: '10px' }}>
          <SettingGeminiModel options={inputs} refresh={refresh} />
        </Card>
        {/* Claude */}
        <Card style={{ marginTop: '10px' }}>
          <SettingClaudeModel options={inputs} refresh={refresh} />
        </Card>
        {/* Grok */}
        <Card style={{ marginTop: '10px' }}>
          <SettingGrokModel options={inputs} refresh={refresh} />
        </Card>
      </Spin>
    </>
  );
