...
func InitOptionMap() {
	...
	common.OptionMap["ViolationAuditEnabled"] = strconv.FormatBool(setting.ViolationAuditEnabled)
	common.OptionMap["ViolationWordLibrary"] = setting.ViolationWordsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "ViolationAuditEnabled":
			setting.ViolationAuditEnabled = boolValue
		case "SMTPSSLEnabled":
	...
	case "ViolationWordLibrary":
		setting.SetViolationWords(value)
