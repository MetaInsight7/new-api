...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.GroupOverride())
	{
	...
	geminiRouter.Use(middleware.GroupOverride())
	{
	...
	geminiCompatibleRouter.Use(middleware.GroupOverride())
	{
	...
	relayV1Router.Use(middleware.GroupOverride())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.GroupOverride(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.GroupOverride())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.GroupOverride(), middleware.Distribute())
	{
